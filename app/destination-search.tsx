...
export default function DestinationSearchScreen() {
  ...
  return (
    <AppScreen backgroundColor={theme.colors.offWhite} scroll contentStyle={styles.container}>
      ...
      <FloatingView style={styles.grid} distance={7}>
        <DottedGrid color="rgba(13,13,13,0.08)" />
      </FloatingView>
      <FloatingView style={styles.wave} delay={140} distance={10}>
      ...
      <RevealView delay={40} from="down" style={styles.content}>
        ...
        <View style={styles.recentSection}>
          ...
          {recentPlaces.map((place, index) => (
            <RevealView key={place.id} delay={120 + index * 80}>
              <Pressable onPress={() => router.push('/ride-selection')}>
